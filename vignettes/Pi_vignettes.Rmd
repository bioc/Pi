...
`Pi` together with dependant packages can be installed following instructions below:
...
```{r fig.width=1.2, fig.height=1.2, fig.align="center", echo=FALSE, eval=TRUE}
library(png)
library(grid)
