...
# to use the latest version of Bioconductor, upgrade it: BiocManager::install("BiocUpgrade") 
...
if (!requireNamespace("BiocManager", quietly=TRUE))
    install.packages("BiocManager")
BiocManager::install(c("XGR","devtools"), siteRepos=c("http://cran.r-project.org"))
