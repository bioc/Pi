...
#' @param parallel logical to indicate whether parallel computation with multicores is used. By default, it sets to true, but not necessarily does so. It will depend on whether these two packages "foreach" and "doParallel" have been installed. It can be installed via: \code{if (!requireNamespace("BiocManager", quietly=TRUE)); BiocManager::install(c("foreach","doParallel"))}. If not yet installed, this option will be disabled
    install.packages("BiocManager"); BiocManager::install(c("foreach","doParallel"))}. If not yet installed, this option will be disabled
